...
close all
    ...
    global delta Ad Bd Hd Kd L1d d dim_n dim_m dim_p%(Ad,Hd) observable; F1 and F2 are Hurwitz; eye(2)-expm(F2*delta)*expm(-F1*delta) is invertible
...
%         out1(i) = sensor.D(tau); %observer event
    ...
    save data_Hee_SOD td_Hee_SOD jd_Hee_SOD xid_Hee_SOD out2_Hee_SOD
end    
